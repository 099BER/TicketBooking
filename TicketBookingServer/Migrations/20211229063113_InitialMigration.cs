    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeatingConfigId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumberOfSeats = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatingConfigs", x => x.SeatingConfigId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Theatres_SeatingConfigs_SeatingConfigId",
                        column: x => x.SeatingConfigId,
                        principalTable: "SeatingConfigs",
                        principalColumn: "SeatingConfigId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "SeatingConfigId", "NumberOfSeats" },
                values: new object[,]
                {
                    { 1, 10 },
                    { 2, 20 }
